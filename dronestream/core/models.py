...
class Strike(models.Model):
    ...
    bij_summary_short = models.CharField(verbose_name=_("BIJ Summary Short"), max_length=1000,
                                         blank=True, null=True)
    bij_link = models.URLField(verbose_name=_("BIJ Link"), blank=True, null=True)

    def __str__(self):
        return self.dronestream_id
